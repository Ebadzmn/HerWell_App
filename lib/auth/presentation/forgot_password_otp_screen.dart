            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      text: 'We\'ve sent a 4-digit reset code to ',
                  ...
                  Obx(() => _buildPrimaryButton(
                    text: controller.isLoading.value ? 'Verifying...' : 'Verify & Reset',
                    onPressed: controller.isLoading.value ? () {} : () async {
                      ...
                      await controller.verifyForgotPasswordOTP(_otp);
                    },
                  )),
                  const SizedBox(height: 32),
                  Center(
                    child: TextButton(
                      onPressed: () => Get.snackbar('Success', 'Reset OTP resent', snackPosition: SnackPosition.BOTTOM),
